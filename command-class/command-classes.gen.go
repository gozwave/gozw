...
import (
	...
	"github.com/helioslabs/gozw/command-class/alarm"
	"github.com/helioslabs/gozw/command-class/alarm-v2"
	"github.com/helioslabs/gozw/command-class/application-status"
	"github.com/helioslabs/gozw/command-class/association"
	"github.com/helioslabs/gozw/command-class/association-v2"
	"github.com/helioslabs/gozw/command-class/basic"
	"github.com/helioslabs/gozw/command-class/battery"
	"github.com/helioslabs/gozw/command-class/clock"
	"github.com/helioslabs/gozw/command-class/color-control"
	"github.com/helioslabs/gozw/command-class/color-control-v2"
	"github.com/helioslabs/gozw/command-class/configuration"
	"github.com/helioslabs/gozw/command-class/configuration-v2"
	"github.com/helioslabs/gozw/command-class/door-lock"
	"github.com/helioslabs/gozw/command-class/door-lock-logging"
	"github.com/helioslabs/gozw/command-class/door-lock-v2"
	...
	"github.com/helioslabs/gozw/command-class/node-naming"
	"github.com/helioslabs/gozw/command-class/notification-v3"
	"github.com/helioslabs/gozw/command-class/notification-v4"
	"github.com/helioslabs/gozw/command-class/security"
	"github.com/helioslabs/gozw/command-class/sensor-configuration"
	"github.com/helioslabs/gozw/command-class/sensor-multilevel"
	"github.com/helioslabs/gozw/command-class/sensor-multilevel-v2"
	"github.com/helioslabs/gozw/command-class/sensor-multilevel-v3"
	"github.com/helioslabs/gozw/command-class/sensor-multilevel-v4"
	"github.com/helioslabs/gozw/command-class/sensor-multilevel-v5"
	"github.com/helioslabs/gozw/command-class/sensor-multilevel-v6"
	"github.com/helioslabs/gozw/command-class/switch-all"
	"github.com/helioslabs/gozw/command-class/switch-binary"
	"github.com/helioslabs/gozw/command-class/switch-toggle-binary"
	"github.com/helioslabs/gozw/command-class/thermostat-fan-mode"
	"github.com/helioslabs/gozw/command-class/thermostat-fan-mode-v2"
	"github.com/helioslabs/gozw/command-class/thermostat-fan-mode-v3"
	"github.com/helioslabs/gozw/command-class/thermostat-fan-mode-v4"
	"github.com/helioslabs/gozw/command-class/thermostat-fan-state"
	"github.com/helioslabs/gozw/command-class/thermostat-mode"
	"github.com/helioslabs/gozw/command-class/thermostat-mode-v2"
	"github.com/helioslabs/gozw/command-class/thermostat-mode-v3"
	"github.com/helioslabs/gozw/command-class/thermostat-operating-state"
	"github.com/helioslabs/gozw/command-class/thermostat-operating-state-v2"
	"github.com/helioslabs/gozw/command-class/thermostat-setpoint"
	"github.com/helioslabs/gozw/command-class/thermostat-setpoint-v2"
	"github.com/helioslabs/gozw/command-class/thermostat-setpoint-v3"
	"github.com/helioslabs/gozw/command-class/time"
	"github.com/helioslabs/gozw/command-class/time-v2"
	"github.com/helioslabs/gozw/command-class/user-code"
	"github.com/helioslabs/gozw/command-class/version"
	"github.com/helioslabs/gozw/command-class/version-v2"
	"github.com/helioslabs/gozw/command-class/wake-up"
	"github.com/helioslabs/gozw/command-class/wake-up-v2"
)
