...
func init() {
	gob.Register(MultiChannelAssociationRemove{})
}
...
func (cmd *MultiChannelAssociationRemove) UnmarshalBinary(data []byte) error {
...
func (cmd *MultiChannelAssociationRemove) MarshalBinary() (payload []byte, err error) {
