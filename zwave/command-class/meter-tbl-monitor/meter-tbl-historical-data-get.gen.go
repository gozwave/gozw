...
func ParseMeterTblHistoricalDataGet(payload []byte) MeterTblHistoricalDataGet {
	val := MeterTblHistoricalDataGet{}
	...
	val.HistoricalDatasetRequested = binary.BigEndian.Uint32(payload[i : i+3])
	i += 3
