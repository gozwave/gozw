...
func init() {
	gob.Register(ThermostatHeatingSetpointSet{})
}
...
func (cmd *ThermostatHeatingSetpointSet) UnmarshalBinary(data []byte) error {
...
func (cmd *ThermostatHeatingSetpointSet) MarshalBinary() (payload []byte, err error) {
