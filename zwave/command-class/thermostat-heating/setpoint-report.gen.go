...
func init() {
	gob.Register(ThermostatHeatingSetpointReport{})
}
...
func (cmd *ThermostatHeatingSetpointReport) UnmarshalBinary(data []byte) error {
...
func (cmd *ThermostatHeatingSetpointReport) MarshalBinary() (payload []byte, err error) {
