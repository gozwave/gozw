...
func init() {
	gob.Register(ThermostatSetpointReport{})
}
...
func (cmd *ThermostatSetpointReport) UnmarshalBinary(data []byte) error {
...
func (cmd *ThermostatSetpointReport) MarshalBinary() (payload []byte, err error) {
