...
func init() {
	gob.Register(ChimneyFanStartTempReport{})
}
...
func (cmd *ChimneyFanStartTempReport) UnmarshalBinary(data []byte) error {
...
func (cmd *ChimneyFanStartTempReport) MarshalBinary() (payload []byte, err error) {
