...
func init() {
	gob.Register(ChimneyFanAlarmTempSet{})
}
...
func (cmd *ChimneyFanAlarmTempSet) UnmarshalBinary(data []byte) error {
...
func (cmd *ChimneyFanAlarmTempSet) MarshalBinary() (payload []byte, err error) {
