...
func init() {
	gob.Register(ChimneyFanStartTempSet{})
}
...
func (cmd *ChimneyFanStartTempSet) UnmarshalBinary(data []byte) error {
...
func (cmd *ChimneyFanStartTempSet) MarshalBinary() (payload []byte, err error) {
