...
func init() {
	gob.Register(MultiInstanceAssociationRemove{})
}
...
func (cmd *MultiInstanceAssociationRemove) UnmarshalBinary(data []byte) error {
...
func (cmd *MultiInstanceAssociationRemove) MarshalBinary() (payload []byte, err error) {
