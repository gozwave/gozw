...
func init() {
	gob.Register(MeterTblPushConfigurationSet{})
}
...
func (cmd *MeterTblPushConfigurationSet) UnmarshalBinary(data []byte) error {
...
func (cmd *MeterTblPushConfigurationSet) MarshalBinary() (payload []byte, err error) {
